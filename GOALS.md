...
- Read-only Git working-tree review for uncommitted added/modified/deleted/renamed files, with bounded text diffs from `HEAD` or another recent commit base.
