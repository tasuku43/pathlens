...
for (const file of required) {
  if (!existsSync(path.join(root, file))) errors.push(`missing required file: ${file}`);
}
for (const file of forbiddenFileNames) {
  if (existsSync(path.join(root, file))) errors.push(`forbidden prompt-like file exists: ${file}`);
}
